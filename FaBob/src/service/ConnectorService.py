...
class ConnectorService:
    ...
    def connect_near_restaurants_to_segments(self):
        ...
        for restaurant in restaurants:
            segments_near_to_restaurant = self.__segment_repository.find_near_segments(
        ...
        print(
            "\n NUMBER OF RESTAURANTS NOT NEAR ANY SEGMENT: ",
            number_of_restaurants_not_near_any_segment,
        )
