...
class MongoRestaurantRepository(RestaurantRepository):
    def __init__(self, mongo_address: str, restaurant_data_filepath) -> None:
    ...
    def __assemble_restaurant(self, restaurant_data_entry) -> Restaurant:
        ...
        coordinates: Coordinates = Coordinates(restaurant_data_entry["coordinates"]["latitude"], restaurant_data_entry["coordinates"]["longitude"])
